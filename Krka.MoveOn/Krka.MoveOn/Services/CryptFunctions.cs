...
public class CryptFunctions
{
    ...
    /// </summary>
    private static readonly string saltValue = "hx_sg@25";            // can be any string
    private static readonly string keyValue = "r@83_KP6";
    /// <summary name="initVector">
    /// Initialization vector (or IV). This value is required to encrypt the
    /// first block of plaintext data. For RijndaelManaged class IV must be 
    /// exactly 16 ASCII characters long.
    /// </summary>
    private static readonly string initVector = "w1HuiT_9";
