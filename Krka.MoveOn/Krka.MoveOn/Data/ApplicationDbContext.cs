...
public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> options) : IdentityDbContext<ApplicationUser>(options) 
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        #region "DialMH"
            modelBuilder.Entity<DialMH>().HasData(new DialMH() { Id = 1, Type_q = 1, Name = "JednostrannÈ prÌznaky", CreatedAt = new(2024, 10, 10), ModifiedAt = new(2024, 10, 10) });
            modelBuilder.Entity<DialMH>().HasData(new DialMH() { Id = 2, Type_q = 1, Name = "JednostrannÈ a axi·lne prÌznaky (hypofÛnia, hypomÌmia, flekËnÈdrûanie tela)", CreatedAt = new(2024, 10, 10), ModifiedAt = new(2024, 10, 10) });
            modelBuilder.Entity<DialMH>().HasData(new DialMH() { Id = 3, Type_q = 1, Name = "ObojstrannÈ prÌznaky bez poruchy rovnov·hy", CreatedAt = new(2024, 10, 10), ModifiedAt = new(2024, 10, 10) });
            modelBuilder.Entity<DialMH>().HasData(new DialMH() { Id = 4, Type_q = 1, Name = "ObojstrannÈ prÌznaky s miernou poruchou rovnov·hy (schopnosù vyrovnaù postoj pri pull teste)", CreatedAt = new(2024, 10, 10), ModifiedAt = new(2024, 10, 10) });
            modelBuilder.Entity<DialMH>().HasData(new DialMH() { Id = 5, Type_q = 1, Name = "Mierne aû strednÈ obojstrannÈ prÌznaky, postur·lnainstabilita, pacient je st·le sebestaËn˝", CreatedAt = new(2024, 10, 10), ModifiedAt = new(2024, 10, 10) });
            modelBuilder.Entity<DialMH>().HasData(new DialMH() { Id = 6, Type_q = 1, Name = "çaûkÈ postihnutie, no pacient je schopn˝ chodiù alebo st·ù bez pomoci", CreatedAt = new(2024, 10, 10), ModifiedAt = new(2024, 10, 10) });
            modelBuilder.Entity<DialMH>().HasData(new DialMH() { Id = 7, Type_q = 1, Name = "Pacient je odk·zan˝ na vozÌk alebo posteæ", CreatedAt = new(2024, 10, 10), ModifiedAt = new(2024, 10, 10) });
        #endregion
