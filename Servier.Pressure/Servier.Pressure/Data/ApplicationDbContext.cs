...
public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> options) : IdentityDbContext<ApplicationUser>(options) 
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 19, Monotherapy = MonotherapyEnum.CalciumChannelBlocker, IsAldosteroneAntagonist = false, Order = 5, Name = "lerkanidipín", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
