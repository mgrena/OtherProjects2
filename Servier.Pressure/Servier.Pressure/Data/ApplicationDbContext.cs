...
public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> options) : IdentityDbContext<ApplicationUser>(options) 
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TreatmentMultitherapyDrug>().HasData(new TreatmentMultitherapyDrug() { Id = 8, Multitherapy = MultitherapyEnum.Antihypertensive2, Order = 8, Name = "lisinopril / amlodipine", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
