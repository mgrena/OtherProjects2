...
public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> options) : IdentityDbContext<ApplicationUser>(options) 
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 1, Monotherapy = MonotherapyEnum.ACEInhibitor, Order = 1, Name = "enalapril", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 2, Monotherapy = MonotherapyEnum.ACEInhibitor, Order = 2, Name = "fosinopril", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 3, Monotherapy = MonotherapyEnum.ACEInhibitor, Order = 3, Name = "imidapril", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 4, Monotherapy = MonotherapyEnum.ACEInhibitor, Order = 4, Name = "kaptopril", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 5, Monotherapy = MonotherapyEnum.ACEInhibitor, Order = 5, Name = "lisinopril", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 6, Monotherapy = MonotherapyEnum.ACEInhibitor, Order = 6, Name = "perindopril", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 7, Monotherapy = MonotherapyEnum.ACEInhibitor, Order = 7, Name = "quinapril", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 8, Monotherapy = MonotherapyEnum.ACEInhibitor, Order = 8, Name = "ramipril", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 9, Monotherapy = MonotherapyEnum.ACEInhibitor, Order = 9, Name = "trandolapril", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 10, Monotherapy = MonotherapyEnum.AngiotensinIIReceptorBlocker, Order = 1, Name = "irbesartan", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 11, Monotherapy = MonotherapyEnum.AngiotensinIIReceptorBlocker, Order = 2, Name = "kandesartan", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 12, Monotherapy = MonotherapyEnum.AngiotensinIIReceptorBlocker, Order = 3, Name = "losartan", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 13, Monotherapy = MonotherapyEnum.AngiotensinIIReceptorBlocker, Order = 4, Name = "telmisartan", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 14, Monotherapy = MonotherapyEnum.AngiotensinIIReceptorBlocker, Order = 5, Name = "valsartan", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 15, Monotherapy = MonotherapyEnum.CalciumChannelBlocker, Order = 1, Name = "amlodipín", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 16, Monotherapy = MonotherapyEnum.CalciumChannelBlocker, Order = 2, Name = "felodipín", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 17, Monotherapy = MonotherapyEnum.CalciumChannelBlocker, Order = 3, Name = "isradipín", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 18, Monotherapy = MonotherapyEnum.CalciumChannelBlocker, Order = 4, Name = "lacidipín", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 19, Monotherapy = MonotherapyEnum.CalciumChannelBlocker, Order = 5, Name = "lerkanidipín", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 20, Monotherapy = MonotherapyEnum.CalciumChannelBlocker, Order = 6, Name = "nifedipín", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 21, Monotherapy = MonotherapyEnum.CalciumChannelBlocker, Order = 7, Name = "nitrendipín", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 22, Monotherapy = MonotherapyEnum.CalciumChannelBlocker, Order = 8, Name = "verapamil", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 23, Monotherapy = MonotherapyEnum.BetaBlocker, Order = 1, Name = "atenolol", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 24, Monotherapy = MonotherapyEnum.BetaBlocker, Order = 2, Name = "betaxolol", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 25, Monotherapy = MonotherapyEnum.BetaBlocker, Order = 3, Name = "bisoprolol", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 26, Monotherapy = MonotherapyEnum.BetaBlocker, Order = 4, Name = "celiprolol", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 27, Monotherapy = MonotherapyEnum.BetaBlocker, Order = 5, Name = "esmololol", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 28, Monotherapy = MonotherapyEnum.BetaBlocker, Order = 6, Name = "karvedilol", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 29, Monotherapy = MonotherapyEnum.BetaBlocker, Order = 7, Name = "labetalol", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 30, Monotherapy = MonotherapyEnum.BetaBlocker, Order = 8, Name = "metipranolol", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 31, Monotherapy = MonotherapyEnum.BetaBlocker, Order = 9, Name = "metoprolol", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 32, Monotherapy = MonotherapyEnum.BetaBlocker, Order = 10, Name = "nebivolol", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 33, Monotherapy = MonotherapyEnum.Diuretic, Order = 1, Name = "HCTZ", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 34, Monotherapy = MonotherapyEnum.Diuretic, Order = 2, Name = "indapamid", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 35, Monotherapy = MonotherapyEnum.Diuretic, Order = 3, Name = "metipamid", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 37, Monotherapy = MonotherapyEnum.AldosteroneAntagonist, Order = 1, Name = "eplerenón", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 38, Monotherapy = MonotherapyEnum.AldosteroneAntagonist, Order = 2, Name = "finerenón", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 39, Monotherapy = MonotherapyEnum.AldosteroneAntagonist, Order = 3, Name = "spironolaktón", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 40, Monotherapy = MonotherapyEnum.Other, Order = 1, Name = "doxazosín", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 41, Monotherapy = MonotherapyEnum.Other, Order = 2, Name = "metyldopa", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 42, Monotherapy = MonotherapyEnum.Other, Order = 3, Name = "metipamid", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 43, Monotherapy = MonotherapyEnum.Other, Order = 4, Name = "moxonidín", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 44, Monotherapy = MonotherapyEnum.Other, Order = 5, Name = "rilmenidín", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        modelBuilder.Entity<TreatmentMonotherapyDrug>().HasData(new TreatmentMonotherapyDrug() { Id = 45, Monotherapy = MonotherapyEnum.Other, Order = 6, Name = "urapidil", CreatedAt = new(2025, 03, 27), ModifiedAt = new(2025, 03, 27) });
        #endregion
