...
public class Processes
{
    ...
    public static async Task<StatusReport> ProcessBatchAsync(AppSettings appSettings, DateTime? startingDate, DateTime? endingDate)
    {
        ...
        IDictionary<string, object?> aData = new Dictionary<string, object?>();
        IDictionary<string, IList<string>> aMissData = new Dictionary<string, IList<string>>();
        ...
        if (aMissData.Any())
        {
            ...
            foreach(KeyValuePair<string, IList<string>> entry in aMissData) 
